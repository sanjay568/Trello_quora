...
public class AdminController {
	...
	public ResponseEntity<Object> deleteUserProfile(@PathVariable("userId") int userId,@RequestHeader("access_token") String access_token){
		...
		if(userEn.getRole()==null) {
			 UserNotFoundException userNF= new UserNotFoundException("ATHR-003","Unauthorized Access, Entered user is not an admin");
			 return new ResponseEntity<Object>(userNF,HttpStatus.NOT_FOUND);
		}
